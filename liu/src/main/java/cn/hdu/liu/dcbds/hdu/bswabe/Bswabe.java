package cn.hdu.liu.dcbds.hdu.bswabe;//package com.hdu.cpabeapi.bswabe;
//
//import cn.hutool.json.JSONObject;
//import com.hdu.data_capsule_local.config.LocalCache;
...
//		/* compute */
//		//r.setToRandom();
//		byte[] userR = (byte[]) LocalCache.CACHE.get("userR");
//		SerializeUtils.unserializeElement(userR,0,r);
//
...
//
//		JSONObject attrRj = (JSONObject) LocalCache.CACHE.get("attrs-rj");
//
//
...
//			//rp.setToRandom();
//			//获取对应的rj
//			SerializeUtils.unserializeElement((byte[])attrRj.get(comp.attr),0,rp);
//
//			h_rp.powZn(rp);
//
...
//		cph.p = parsePolicyPostfix(policy); // 初始化policy树
//
//		/* compute */
//		m.setToRandom();
//		s.setToRandom();
...
//
//
//		JSONObject attrG = (JSONObject) LocalCache.CACHE.get("attrs-grj");
//		p.gri.setFromBytes((byte[])attrG.get("s"));
//		//SerializeUtils.unserializeElement((byte[])attrG.get(s),0,p.gri);
//
//		p.k = k;
//		if (!(s == null))
//			p.attr = s;
