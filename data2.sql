...
INSERT INTO data_objects (
    ...
    '{"entity":"民政数据","status":"待检验","feedback":"","metadata":null,"dataItems":[
	...
	'{
        "databaseName": "民政核心数据库",
        "tableName": "CivilAffairs",
        "selectFields": "Name,Gender,Age,IDCard,ResidentialAddress,EconomicIncome,MinimumLivingAllowance,TemporaryAssistance,ExtremelyPoorSupport,Importance"
    }',
...
INSERT INTO data_objects (
    ...
    '{"entity":"人社仿真数据","status":"已合格","feedback":"","metadata":null,"dataItems":[
    ...
    '{"locationInfo": {
        ...
        "selectFields": "Name,Gender,Age,IDCard,ResidentialAddress,UnemploymentStatus,FlexibleEmployment,PensionAmount,Importance"
    }}',
...
INSERT INTO data_objects (
    ...
    '{"entity":"税务仿真数据","status":"待检验","feedback":"","metadata":null,"dataItems":[
    ...
    '{"locationInfo": {
        "databaseName": "税务信息库",
        "tableName": "TaxBureau",
        "selectFields": "Name,Gender,Age,IDCard,ResidentialAddress,FamilyTaxAmount,TaxExemptionInfo,IncomeStatusAssessment,Importance"
    }}',
...
INSERT INTO data_objects (
    ...
    '{"entity":"社区服务数据","status":"不合格","feedback":"数据不完整","metadata":null,"dataItems":[
    ...
    '{"locationInfo": {
        "databaseName": "社区服务信息库",
        "tableName": "CommunityServiceCenter",
        "selectFields": "Name,Gender,Age,IDCard,ResidentialAddress,HousingCondition,DisabilityStatus,HomeVisitStatus,Importance"
    }}',
